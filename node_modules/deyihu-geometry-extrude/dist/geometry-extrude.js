(function (global, factory) {
    ...
    (global = global || self, factory(global.geometryExtrude = {}));
    ...
    */
    ...
    // offsetLines
    {
        ...
        var prevOffsetX = void 0;
        var prevOffsetY = void 0;
        var prevCursor = void 0;
        var tmpIntersection = [];
    ...
    function innerOffsetPolyline(vertices, out, start, end, outStart, offset, miterLimit, close) {
        var checkMiterLimit = miterLimit != null;
        var outOff = outStart;
        var indicesMap = null;
        if (checkMiterLimit) {
    ...
    function addExtrudeSide(out, _ref, start, end, cursors, opts) {
        ...
        var ringPerimeter = cursors.ringPerimeter;
        var size = Math.max(rect.width, rect.height, depth, ringPerimeter);
        ...
        if (bevelSize > 0) {
            ...
            for (var _k = 0; _k < 2; _k++) {
                ...
                for (var _i2 = 0; _i2 < ringVertexCount; _i2++) {
                    ...
                    var _x2 = vertices[_idx];
                    var _y = vertices[_idx + 1];
                    out.position[cursors.vertex * 3] = _x2;
                    out.position[cursors.vertex * 3 + 1] = _y;
                    out.position[cursors.vertex * 3 + 2] = _z;
                    if (_i2 > 0) {
                        _uLen += Math.sqrt((_prevX - _x2) * (_prevX - _x2) + (_prevY - _y) * (_prevY - _y));
                    }
    ...
    function innerExtrudeTriangulatedPolygon(preparedData, opts) {
        ...
        for (var p = 0; p < preparedData.length; p++) {
            ...
            var holes = preparedData[p].holes || [];
        ...
        for (var _d = 0; _d < preparedData.length; _d++) {
            ...
            var _vertexCount = vertices.length / 2;

            var _start = 0;
            var _end = _holes && _holes.length ? _holes[0] : _vertexCount;
            cursors.ringPerimeter = ringDistance(preparedData[_d].topVertices, _start, _end);
            // Add exterior
    ...
    function convertPolylineToTriangulatedPolygon(polyline, polylineIdx, opts) {
        ...
        var outsideIndicesMap = innerOffsetPolyline(points, outsidePoints, 0, pointCount, 0, -lineWidth / 2, miterLimit, false, true);
        reversePoints(points, 2, 0, pointCount);
        var insideIndicesMap = innerOffsetPolyline(points, insidePoints, 0, pointCount, 0, -lineWidth / 2, miterLimit, false, true);
