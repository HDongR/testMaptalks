    ...
    */
    ...
    class ExtrudePolygons extends MergedMixin(BaseObject) {
        constructor(polygons, options, material, layer) {
            ...
            if(options.is3D){
                let preStartIdx = 0;
                for(var _i=0; _i<this._datas.length; _i++){
                    ...
                    let custom_altitude = this._datas[_i].properties.altitude;
                    
                    let startIdx = preStartIdx;
                    let endIdx = startIdx + vertCnt;
                    //for(var j=startIdx+2; j<endIdx; j+=3){
                        //this.object3d.geometry.attributes.position.array[j] += custom_altitude;
                    //}
                    preStartIdx = endIdx;
                }
            ...
            this.vertDiffIdxList = vertDiffIdxList;
        }
        // eslint-disable-next-line consistent-return
        getSelectMesh() {
            const index = this._getIndex();
    ...
    class FlatPolygons extends MergedMixin(BaseObject){
        constructor(polygons, options, material, layer) {
            if (!Array.isArray(polygons)) {
                polygons = [polygons];
            }
            ...
            //Face corresponding to monomer
            this._faceMap = faceMap;
            this._baseObjects = flatPolygons;
            this._datas = polygons;
            this._geometriesAttributes = geometriesAttributes;
            this.faceIndex = null;
            this._geometryCache = bufferGeometry.clone();
            this.isHide = false;
            this._colorMap = {};
            this._initBaseObjectsEvent(flatPolygons);
            if (!asynchronous) {
                this._setPickObject3d();
                this._init();
            }
            this.type = 'FlatPolygons';
    ...
    */
    ...
    class ThreeLayer extends maptalks.CanvasLayer {
        ...
        distanceToVector3(w, h, coord) {
            ...
            const p0 = map.coordinateToPoint(center, zoom), p1 = map.coordinateToPoint(target, zoom);
        ...
        */
         ...
         * @returns 
         */
         toFlatPolygons = function (polygons, options, material) {
